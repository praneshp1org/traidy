...
class WithdrawWithdrawAmountScreen
    extends GetWidget<WithdrawWithdrawAmountController> {
  TextEditingController pinController = TextEditingController();
  WithdrawWithdrawAmountController withdrawAmountController =
      WithdrawWithdrawAmountController();
  @override
                            ...
                            Column(
                                ...
                                children: [
                                  ...
                                  CustomDropDown(
                                      ...
                                      items: controller
                                          .withdrawWithdrawAmountModelObj
                                          .value
                                          .dropdownItemList,
                                      onChanged: (value) {
                                  ...
                                  KeyPad(
                                    ...
                                    isPinLogin: false,
                                    onChange: (String pin) {
                                      withdrawAmountController.setAmount(pin);
                                      print("pin is $pin");
                                    },
                                    onSubmit: (String pin) {
                                      withdrawAmountController.setAmount(pin);
                                  ...
                                  SliderButton(
                                    ...
                                    action: () {
                                      Get.toNamed(
                                          AppRoutes.withdrawSummaryScreen);
                                    },
